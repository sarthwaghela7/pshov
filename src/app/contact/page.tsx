...
import { Send, Users, LineChart, Coins } from 'lucide-react';
import AnimatedText from '@/components/ui/AnimatedText';
import SectionLabel from '@/components/ui/SectionLabel';
import Button from '@/components/ui/Button';
import styles from './page.module.css';

type FormIntent = 'invest' | 'work' | 'grow' | '';

export default function ContactPage() {
  const [formIntent, setFormIntent] = useState<FormIntent>('');
  const formRef = useRef<HTMLDivElement>(null);

  // Active ventures for multi-select (mocked)
  ...
  const handlePillarClick = (intent: FormIntent) => {
  ...
  return (
    <>
      ...
      {/* ============ SMART FORM ============ */}
      <section className={`${styles.formSection} section`} ref={formRef}>
        <div className="container">
              ...
              <div className={styles.formGrid}>
                ...
                <div className={styles.formGroup}>
                  ...
                  <select 
                    ...
                    required 
                    value={formIntent} 
                    onChange={(e) => setFormIntent(e.target.value as FormIntent)}
                  >
                ...
                {formIntent === 'invest' && (
                  ...
                  >
                    <div className={styles.formGroup}>
                      ...
                      <input type="text" id="investVenture" placeholder="e.g. Impactshaala" />
                    </div>
                    ...
                    <div className={styles.formGroup}>
                      ...
                      <textarea id="investAbout" rows={4} placeholder="Tell me about your background..." />
                    </div>
                ...
                {formIntent === 'work' && (
                  ...
                  >
                    ...
                    <div className={styles.formGroup}>
                      ...
                      <textarea id="workSkills" required rows={4} placeholder="Marketing, Operations, React, Design..." />
                    </div>
                ...
                {formIntent === 'grow' && (
                  ...
                  >
                    ...
                    <div className={styles.formGroup}>
                      ...
                      <textarea id="growDesc" required rows={4} placeholder="We are a B2B SaaS struggling with..." />
                    </div>
                  </motion.div>
                )}
